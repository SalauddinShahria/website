	              	...
	              	<div class="row">
	              		<div class="col-sm-6 col-xl-6">
	              			<form action="{{ route('slider.store') }}" method="POST" enctype="multipart/form-data">
			              		...
			              		<div class="form-group">
			              			...
			              			<input type="text" name="subtitle" class="form-control" autocomplete="off" required="required">
			              		</div>

			              		<div class="form-group">
			              			<label>Button Text</label>
			              			<input type="text" name="button_text" class="form-control" autocomplete="off" required="required">
			              		</div>

			              		<div class="form-group">
			              			<label>Button URL</label>
			              			<input type="text" name="button_url" class="form-control" autocomplete="off" required="required">
			              		</div>
			            ...
			            <div class="col-sm-6 col-xl-6">
			              		...
			              		<div class="form-group">
			              			...
			              			<textarea name="description" class="form-control" required="required" rows="10"></textarea>
			              		</div>
